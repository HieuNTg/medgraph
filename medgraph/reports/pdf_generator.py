...
def generate_report_pdf(
    ...
    risk_data = [[
        Paragraph(f"<b>Overall Risk Level: {overall_risk.upper()}</b>",
                  ParagraphStyle("risk", parent=body_style, textColor=risk_color, fontSize=11)),
        Paragraph(f"<b>{len(interactions)}</b> interaction(s) found across <b>{len(drugs)}</b> medication(s)",
    ...
    if interactions:
        ...
        for ix in sorted_interactions:
            ...
            story.append(Paragraph(
                ...
                ParagraphStyle("ixhead", parent=body_style, fontSize=10, spaceBefore=8, spaceAfter=4),
            ))
            ...
            if mech:
                story.append(Paragraph(
                    ...
                    ParagraphStyle("mech_detail", parent=body_style, fontSize=8,
            ...
            if cascades:
                for cp in cascades[:2]:  # limit to 2 cascade paths
                    ...
                    if path_desc:
                        story.append(Paragraph(
                            f"Cascade: {path_desc}",
                            ParagraphStyle("cascade", parent=body_style, fontSize=8, leftIndent=12,
    ...
    if graph_png_b64:
        ...
        try:
            ...
            story.append(Paragraph(
                ...
                ParagraphStyle("caption", parent=body_style, fontSize=7,
